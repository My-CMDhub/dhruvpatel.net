...
export const forCase: Record<string, Partial<Record<PersonaId, string>>> = {
  ovela: {
    ...
    recruiter: 'Voice AI on a live phone line, built solo. Python, FastAPI, asyncio, Twilio, SST, LLM, TTS, Appwrite. First reply 3.7 s → 0.9 s, measured from two recordings you can play on this page. 1,922 tests.',
  },
  'agent-os': {
