...
<CaseHead
  ...
  meta="Personal project · no customers; every call is my own test call · Python, FastAPI, asyncio, Twilio, Deepgram Flux, gpt-4.1-nano, Cartesia, Appwrite, Next.js · 1,922 tests"
...
<ul className="sources">
  ...
  <Src id="call">The two calls above, recorded 20 September 2026 on the live number. Both sides were recorded on separate channels, which is how the answer times are measured; the transcript is Deepgram's, of the same file the page plays.</Src>
</ul>
