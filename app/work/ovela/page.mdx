...
<CaseHead
  title="Ovela"
  result="A voice receptionist on a real phone line. Replies that need no tool start in 0.55–0.71 s, and it's built around the parts of a call that usually go wrong."
