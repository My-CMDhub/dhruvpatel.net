...
<Media src="/media/capstone-demo.mp4" poster="/media/capstone-demo.jpg" alt="Demo: an ETH checkout on Sepolia, paid from MetaMask, confirmed on the merchant dashboard" caption="From the team's demo. I present the checkout and the payment; Vladimir shows the merchant releasing the funds." />
